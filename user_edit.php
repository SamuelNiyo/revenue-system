...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  $id = $_GET["id"];
    ...
    if (empty($id) || empty($first_name) || empty($last_name) || empty($tin_number) || empty($address) || empty($email) || empty($registration_date) || empty($agent_id)) {
        echo "All feild are required!";
    }else {
        $sql = "UPDATE user SET id='$id', first_name='$first_name', last_name='$last_name', tin_number='$tin_number', address='$address',email='$email',registration_date='$registration_date',agent_id='$agent_id' WHERE id='$id'";
    }
...
<center>
    ...
    <input type="text" name="id" readonly class="input" value="<?php echo $id; ?>"><br>
