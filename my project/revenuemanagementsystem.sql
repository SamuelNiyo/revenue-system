...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2024 at 09:07 AM
...
INSERT INTO `agent` (`agid`, `first_name`, `last_name`, `email`, `telephone`, `adminid`, `managerid`) VALUES
(1, 'sam', 'niyomurengezi', 'sam@gmail.com', 788201441, 1, 14),
(2, 'aime', 'marie', 'aimemarie12@gmail.com', 788835353, 1, 34),
(5, 'Edison', 'Twahirwa', 'edisontwa@gmail.com', 735353343, 1, 101);
...
(1, 'ab', 'ndayishimiye', 1212389585, 'muhanga', 'ndayishabias@gmail.com', '2024-04-15', 1),
(2, 'eric', 'niyobyose', 1212345678, 'Musanze', 'niyobyosearic3@gmail.com', '2024-04-17', 1),
(5, 'vestine', 'Veve', 112223445, 'Muhanga', 'vestine12@gmail.com', '2024-04-17', 1);
...
--
ALTER TABLE `adminn`
  MODIFY `aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1224;
...
--
ALTER TABLE `agent`
  ADD CONSTRAINT `agent_ibfk_1` FOREIGN KEY (`adminid`) REFERENCES `agent` (`agid`),
